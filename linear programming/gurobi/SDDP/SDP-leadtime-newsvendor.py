...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug  6 20:03:14 2023
...
class State:
    def __init__(self, t: int, iniInventory: float, preQ: float):
        self.t = t
    ...
    def __hash__(self):
        return hash(str(self.t) + str(self.iniInventory) + str(self.preQ))

    def __eq__(self, other):
        return self.t == other.t and self.iniInventory == other.iniInventory\
                and self.preQ == other.preQ
...
class StochasticInventory:
    ...
    def state_tran(self, state:State, action, demand):
        ...
        return State(state.t + 1, nextInventory, action)
