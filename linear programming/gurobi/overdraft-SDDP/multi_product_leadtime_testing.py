...
final expected total profits after 490 iteration is 2209.15
ordering Q1 and Q2 in the first peiod is 74.03 and 57.27
cpu time is 3601.847 s
expected lower bound gap is 1486.36
lower bound and upper bound gap is 32.72%
confidence interval for expected objective is [696.90,  2275.83];
...
planning horizon length is T = 6 
final expected total profits after 184 iteration is 425.46
ordering Q1 and Q2 in the first peiod is 28.50 and 27.47
cpu time is 3631.586 s
expected lower bound gap is 370.10
lower bound and upper bound gap is 13.01%
confidence interval for expected objective is [138.90,  601.30];
