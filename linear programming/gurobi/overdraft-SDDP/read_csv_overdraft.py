...
@disp:  read the output csv files of enhancement comparisons
...
df2 = pd.read_csv('/Users/zhenchen/Library/CloudStorage/OneDrive-BrunelUniversityLondon/Numerical-tests/overdraft/multiproduct_similarity_tests.csv')
...
df3 = pd.read_csv('/Users/zhenchen/Library/CloudStorage/OneDrive-BrunelUniversityLondon/Numerical-tests/overdraft/multiproduct_cutselection_tests.csv')
df3 = df3.drop_duplicates(keep=False, ignore_index=True)
df3['overdraft_interest_rate'] = df3['overdraft_interest_rate'].astype(float)
df3['overdraft_limit'] = df3['overdraft_limit'].astype(int)
df3 = df3[(df3['overdraft_interest_rate'] == 0.1) & (df3['overdraft_limit'] == 500)]
...
df4 = pd.read_csv('/Users/zhenchen/Library/CloudStorage/OneDrive-BrunelUniversityLondon/Numerical-tests/overdraft/multiproduct_hybrid_tests.csv')
...
df_final.to_csv('/Users/zhenchen/Library/CloudStorage/OneDrive-BrunelUniversityLondon/Numerical-tests/overdraft/compare_result.csv')