...
sources = ['大修', '供电分离', '基建', '技改', '居配', '零购', '配网', '信息', '营销', '应急', '运维及成本']
...
for source in sources:
    ...
    df2015_total = pd.read_excel(os.path.join(file_direct, "2015年协议库存用量统计.xlsx"), encoding='gbk', sheet_name="使用金额")
    ...
    df2016_total = pd.read_excel(os.path.join(file_direct, "2016年协议库存用量统计.xlsx"), encoding='gbk', sheet_name="使用金额")
    ...
    df2017_total = pd.read_excel(os.path.join(file_direct, "2017年协议库存用量统计.xlsx"), encoding='gbk', sheet_name="使用金额")
    ...
    df2018_total = pd.read_excel(os.path.join(file_direct, "2018年协议库存用量统计.xlsx"), encoding='gbk', sheet_name="使用金额")
    ...
    filename = source + '合并删除增加电商等14-18-金额.xlsx'
    df_merge_14to18.to_excel(filename, encoding='gbk')
