...
sale_datas = pd.read_csv(
    r"/Users/zhenchen/Library/CloudStorage/OneDrive-BrunelUniversityLondon/投稿/在写论文/杉树科技挑战赛/data/sales_data.csv"
)
...
leadtime = pd.read_csv(
    r"/Users/chen/Documents/投稿/在写论文/杉树科技竞赛/original_data/leadtime_data.csv"
)
...
for name, data in df3:
    dfs.append(data)
    file_address = (
        "/Users/chen/Documents/投稿/在写论文/杉树科技竞赛/dc_sku_leadtime_data/"
    )
    xls_name = file_address + str(name) + ".csv"
    data.to_csv(xls_name, index=False)
